...
namespace BlueLightSoftware.Common
{
    ...
    public static class Keyboard
    {
        ...
        /// </remarks>
        public static bool IsComputerKeyDown(Keys keyPressed, bool rightNow = false, bool ignoreModifiers = true)
        {
            if (!IsKeyboardOpen)
            {
        ...
        ///     3 - Keyboard isn't active
        /// </remarks>
        public static bool IsAnyComputerKeyDown(bool rightNow, params Keys[] keysPressed)
        {
            if (!IsKeyboardOpen)
            {
        ...
        /// <param name="rightNow">If true, checks if the key is still pressed down during this frame render</param>
        /// <returns></returns>
        public static bool IsKeyDownWithModifier(Keys mainKey, Keys modifierKey, bool rightNow = false)
        {
